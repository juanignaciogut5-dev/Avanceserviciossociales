...
- **Insertar imagen** (la subida `IMG_0560.jpeg`, que ya incluye branding de Avance + ambulancia + datos de contacto) **entre el subtítulo y la lista de beneficios**, de modo que la sección quede: título → imagen → beneficios → botón WhatsApp.
