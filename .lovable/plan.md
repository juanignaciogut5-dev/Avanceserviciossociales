...
## Ubicación
Se inserta **justo después del Hero y antes de Servicios** (`#servicios`), para reforzar confianza apenas el usuario entra a la página. No se agrega a `navLinks` (es una franja de logos, no una sección de navegación).
