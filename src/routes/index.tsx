          ...
          <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
            ...
            <div className="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <article className="flex flex-col items-center rounded-3xl border border-border bg-background p-10 text-center shadow-[var(--shadow-soft)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-lift)] md:p-12">
                ...
                <span className="mt-6 inline-block rounded-full bg-primary px-6 py-3 text-xs font-medium leading-relaxed tracking-wide text-primary-foreground/90 md:text-sm">
                  Afiliados de Avance, podras obtener importantes beneficios en
                  todos los productos.
                </span>
              </article>
