  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main id="top">
        ...
        {/* ÁREA JURIDICA INTEGRAL */}
        <section id="area-juridica" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          <div className="flex flex-col items-center text-center">
            <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-primary/8 text-primary">
              <Scale className="h-7 w-7" strokeWidth={1.7} />
            </span>
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2">
            {/* Luppi Leticia */}
            <article className="flex flex-col rounded-2xl border border-border bg-background p-8 text-center shadow-[var(--shadow-soft)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-lift)] md:p-10">
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-primary/8 text-primary">
                <Scale className="h-6 w-6" strokeWidth={1.7} />
              </span>
              ...
              <a
                href={`https://wa.me/5493547592347?text=${encodeURIComponent(
                  "Hola, quiero contactarme con la Dra. Leticia Luppi."
                )}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-7 inline-flex items-center justify-center gap-2.5 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-lift)] transition-all duration-200 hover:bg-primary/90"
              >
                <WhatsAppIcon className="h-4 w-4" />
                Contactar a Leticia Luppi
              </a>
            </article>
            ...
            <article className="flex flex-col rounded-2xl border border-border bg-background p-8 text-center shadow-[var(--shadow-soft)] transition-all duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-lift)] md:p-10">
              ...
              <ul className="mx-auto mt-5 flex max-w-sm flex-wrap items-center justify-center gap-2 text-sm text-navy/80">
                {[
                  ...
                  "Reclamos a A.R.T.",
                  "Daños y Perjuicios",
                  "Accidentes y Multas de Tránsito",
                  "Previsional: Ajustes Jubilatorios",
                ].map((a) => (
                  <li
                    key={a}
                    className="rounded-full border border-border bg-surface px-3 py-1 text-xs font-medium"
              ...
              <a
                href={`https://wa.me/5493515514595?text=${encodeURIComponent(
                  "Hola, quiero contactarme con el Dr. Sergio Sanchez."
                )}`}
                target="_blank"
                rel="noopener noreferrer"
                className="mt-7 inline-flex items-center justify-center gap-2.5 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-[var(--shadow-lift)] transition-all duration-200 hover:bg-primary/90"
